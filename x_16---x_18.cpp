...
int Test_Condition(int C[16])
{
     ...
     if (C[ 0] == 0x0 and C[ 1] == 0x0 and C[ 2] == 0xa and C[ 3] == 0x0 and
         C[ 4] == 0xa and C[ 5] == 0xf and C[ 6] == 0x0 and C[ 7] == 0x0 and
         C[ 8] == 0x0 and C[ 9] == 0xa and C[10] == 0x0 and C[11] == 0x0 and
         C[12] == 0x0 and C[13] == 0xa and C[14] == 0x0 and C[15] == 0x0)
     {
          return 1;
     }
...
int main()
{
    ...
    int R0 = 2;              /* Number of rounds */
    double d = pow(2, 16);      /* Number of pairs */
    ...
    cout << "average pro: " << log2(Pr_sum/KN);
